...
import { Card, CardMedia, Typography, CardActions, CardContent, Button, Alert, CircularProgress } from "@mui/material";
                ...
                <CardContent>
                    ...
                    <div id="main-card">
                        ...
                        <div id="main-card__percipitation">
                            ...
                            <img src={`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@4x.png`} alt="current weather icon" />
                        </div>
                    </div>
